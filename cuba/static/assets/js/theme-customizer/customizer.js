...
(function () {
  ...
  for (const param of params) {
    if (param[0] == "layout_type") {
      ...
      console.log("adding type to:", type);
    } else console.log("not layout_type");
  }
  ...
  switch (type) {
    ...
    case "advance-type": {
      console.log("settings layout adv-type");
      $(".page-wrapper").attr(
        "class",
  ...
  $(".sidebar-type li").on("click", function () {
    ...
    switch (type) {
      ...
      case "normal-sidebar": {
        $(".logo-wrapper")
          .find("img")
          .attr("src", "/static/assets/images/logo/logo.png");
