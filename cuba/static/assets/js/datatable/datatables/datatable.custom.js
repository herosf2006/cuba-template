$(document).ready(function() {
    ...
    $('#data-source-2').DataTable({
        "ajax": '/cuba/static/assets/ajax/arrays.txt'
    });
    var dataSet = [
    ...
    $('#data-source-4').DataTable({
        ...
        "ajax": "/cuba/static/assets/json/server-side.json"
    } );
    ...
    var ct = $('#API-chield-row').DataTable({
        "ajax": "/static/assets/ajax/api.txt",
        "columns": [{
    ...
    $('#ajax-data-object').DataTable({
        "ajax": "/cuba/static/assets/ajax/object.txt",
        "columns": [{
            "data": "name"
        }, {
            "data": "position"
    ...
    $('#ajax-data-nested-object').DataTable({
        "processing": true,
        "ajax": "/cuba/static/assets/ajax/object_nested.txt",
        "columns": [{
            "data": "name"
            }, {
                "data": "hr.position"
    ...
    $('#orthogonal-data').DataTable({
        ajax: "/cuba/static/assets/ajax/orthogonal.txt",
        columns: [{
            data: "name"
        }, {
            data: "position"
    ...
    $('#server-side-datatable').DataTable( {
        "processing": true,
        "serverSide": true,
        "ajax": "/cuba/static/assets/ajax/server-processing.php"
    });
    ...
    $('#datatable-http').DataTable({
        ...
        "serverSide": true,
        "ajax": {
            url: "/cuba/static/assets/ajax/server-processing.php",
            data: function(d) {
                d.myKey = "myValue";
            }
        },  
    ...
    $('#datatable-post').DataTable({
        ...
        "serverSide": true,
        "ajax": {
            url: "/cuba/static/assets/ajax/post.php",
            type: "post"
        },
        "columns": [{
            "data": "first_name"
